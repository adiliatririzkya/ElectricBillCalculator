...
<body>
  ...
  <h1>PEMAKAIAN PERBULAN</h1>
  
</hgroup>
<form method="post" action="bulanproses.php">
  <div class="group">
  ...
  <div class="group">
    ...
    <div class="group">
    <input type="text" name="jumlah_menit" class="bil" autocomplete="off"><span class="highlight"></span><span class="bar"></span>
    <label>Masukan Jumlah Menit</label>
  </div>
    <div class="group">
  ...
  <div class="group">
    <input type="text" name="hari" class="bil" autocomplete="off"><span class="highlight"></span><span class="bar"></span>
