<?php
	if (isset($_POST['hitung']))
	{
		...
		{
		$result = $client->Pemakaian_PerBulan($params);
		echo "
<html>
<head>
...
<form method='post' action='index.php'>
  <td align='center'>";
echo "<h2 class='judul'><align='center'>Biaya Pemakaian PerBulan adalah :<br><b> $result->Pemakaian_PerBulanResult</b> Rupiah</td><br></h2>";
